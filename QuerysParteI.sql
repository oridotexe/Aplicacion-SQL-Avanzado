...
SELECT CLI.NOMBRE_CL, F.FECHA_FACTURA, F.ID_FACTURA, F.VR_ANTES_IVA, COB.FECHA_COBRO, COB.VALOR_COBRADO SUMA
FROM CLIENTES CLI
...
-- Consulta 7 (INCOMPLETA)

SELECT V.VENDEDOR, CN.CANAL_VENTA, F.ID_FACTURA, F.TOTAL_FACTURA, COB.VALOR_COBRADO, ROUND((COB.VALOR_COBRADO/F.TOTAL_FACTURA)*100 , 2)
FROM VENDEDORES V
